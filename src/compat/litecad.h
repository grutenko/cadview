...
#define LC_PROP_WND_ENT 353        // R  void *; picked entity (see lcWndPickEnt function)
...
#define LC_PROP_DRW_LAYER 3081     // RW handle|string; void *to active layer|Name of active layer
#define LC_PROP_DRW_LINETYPE 3082  // RW handle|string; void *to active linetype|Name of active linetype
#define LC_PROP_DRW_LTSCALE 3083   // RW float; active linetype scale
#define LC_PROP_DRW_TEXTSTYLE 3084 // RW handle|string; void *to active text style|Name of active text style
#define LC_PROP_DRW_DIMSTYLE 3085  // RW handle|string; void *to active dim style|Name of active dim style
...
#define LC_PROP_DRW_MLSTYLE                                                                                                                                    \
  3087                         // RW handle|string; void *to active mline style|Name of active mline \
                               // style
#define LC_PROP_DRW_BLOCK 3089 // RW handle|string; void *to active block|Name of active block
#define LC_PROP_DRW_VISBLOCK                                                                                                                                   \
  3090                             // RW handle|string; void *to currently visible block|Name of currently \
                                   // visible block
#define LC_PROP_DRW_LAYOUT 3091    // RW handle|string; void *to active layout (Tab)
...
#define LC_PROP_DRW_LINFILL 3098   // RW handle|string; void *to active linfill|Name of active linfill
...
#define LC_PROP_DRW_LINETYPE_CONT 3153  // R  handle; void *to linetype "Continuous"
#define LC_PROP_DRW_LINETYPE_BYLAY 3154 // R  handle; void *to linetype "ByLayer"
#define LC_PROP_DRW_LINETYPE_BYBLK 3155 // R  handle; void *to linetype "ByBlock"
#define LC_PROP_DRW_TEXTSTYLE_STD 3156  // R  handle; void *to text style "Standard"
#define LC_PROP_DRW_TSTYLE_STD 3156     // same as LC_PROP_DRW_TEXTSTYLE_STD
#define LC_PROP_DRW_PNTSTYLE_STD 3157   // R  handle; void *to point style "Standard"
#define LC_PROP_DRW_DIMSTYLE_STD 3158   // R  handle; void *to dim style "Standard"
#define LC_PROP_DRW_MLSTYLE_STD 3159    // R  handle; void *to mline style "Standard"
...
LCAPI int lcGridSetView(void *hGrid, int Mode, void *hLcWnd, int ColLine,
...
LCAPI void lcGetPolarPoint(double x0, double y0, double Angle, double Dist, double *pOutX, double *pOutY);
LCAPI void lcGetPolarPrm(double x1, double y1, double x2, double y2, double *pAngle, double *pDist);
...
LCAPI void *lcDrwAddPntStyle(void *hDrw, char *szName, void *hBlock, double BlockScale, void *hTStyle, double TextHeight, double TextWidth);
...
LCAPI int lcBlockRasterize(void *hBlock, char *szFileName, double Xmin, double Ymin, double Xmax, double Ymax, int ImgW, int ImgH);
LCAPI int lcBlockRasterizeMem(void *hBlock, void *hMem, double Xmin, double Ymin, double Xmax, double Ymax, int ImgW, int ImgH);
...
LCAPI void *lcBlockAddRPolygon(void *hBlock, int nVers, double Xc, double Yc, double R, double Ang0, int bInscribed, int bFilled);
...
LCAPI void *lcBlockAddRect2(void *hBlock, double Left, double Bottom, double Width, double Height, double Rad, int bFilled);
...
LCAPI void *lcBlockAddEllipse(void *hBlock, double X, double Y, double R1, double R2, double RotAngle, double StartAngle, double ArcAngle);
LCAPI void *lcBlockAddText(void *hBlock, char *szText, double X, double Y);
LCAPI void *lcBlockAddText2(void *hBlock, char *szText, double X, double Y, int Align, double H, double WScale, double RotAngle, double Oblique);
LCAPI void *lcBlockAddText3(void *hBlock, char *szText, double X1, double Y1, double X2, double Y2, int Align, double HW, double Oblique);
LCAPI void *lcBlockAddTextWin(void *hBlock, char *szText, double X, double Y);
LCAPI void *lcBlockAddTextWin2(void *hBlock, char *szText, double X, double Y, int Align, double H, double WScale, double RotAngle, double Oblique);
LCAPI void *lcBlockAddMText(void *hBlock, char *szText, double X, double Y, double WrapWidth, int Align, double RotAngle, double H, double WScale);
LCAPI void *lcBlockAddArcText(void *hBlock, char *szText, double X, double Y, double Radius, double StartAngle, int bClockwise, double H, double WScale,
                              int Align);
LCAPI void *lcBlockAddBlockRef(void *hBlock, void *hRefBlock, double X, double Y, double Scal, double Angle);
LCAPI void *lcBlockAddBlockRefID(void *hBlock, int idRefBlock, double X, double Y, double Scal, double Angle); // undoc
LCAPI void *lcBlockAddBlockRefIDH(void *hBlock, char *szIdRefBlock, double X, double Y, double Scal,
                                  double Angle); // undoc
LCAPI void *lcBlockAddAttDef(void *hBlock, int Mode, char *szTag, char *szPrompt, char *szDefVal, double X, double Y, int Align, double H, double WScale,
...
LCAPI void *lcBlockAddBarcode(void *hBlock, int BarType, double Xc, double Yc, double Width, double Height, char *szText);
LCAPI void *lcBlockAddHatch(void *hBlock, char *szFileName, char *szPatName, double Scal, double Angle);
LCAPI void *lcBlockAddViewport(void *hBlock, double Lef, double Bot, double Width, double Height, double DrwPntX, double DrwPntY, double DrwScale,
                               double DrwAngle);
LCAPI void *lcBlockAddFace(void *hBlock, int Flags, double x0, double y0, double z0, double x1, double y1, double z1, double x2, double y2, double z2);
LCAPI void *lcBlockAddFace4(void *hBlock, int Flags, double x0, double y0, double z0, double x1, double y1, double z1, double x2, double y2, double z2,
                            double x3, double y3, double z3);
LCAPI void *lcBlockAddLeader(void *hBlock, char *szText, double Xt, double Yt, double LandDist, double Xa, double Ya, int Attach, int Align);
LCAPI void *lcBlockAddDimLin(void *hBlock, double X0, double Y0, double X1, double Y1, double Xt, double Yt, double Angle, char *szText);
...
LCAPI void *lcBlockAddDimAli(void *hBlock, double X0, double Y0, double X1, double Y1, double Xt, double Yt, char *szText);
...
LCAPI void *lcBlockAddDimRad(void *hBlock, double Xc, double Yc, double Xr, double Yr, double Xt, double Yt, char *szText);
LCAPI void *lcBlockAddDimRad2(void *hBlock, double Xc, double Yc, double R, double Angle, double TextOff, char *szText);
LCAPI void *lcBlockAddDimDia(void *hBlock, double Xc, double Yc, double Xr, double Yr, double Xt, double Yt, char *szText);
LCAPI void *lcBlockAddDimDia2(void *hBlock, double Xc, double Yc, double R, double Angle, double TextOff, char *szText);
LCAPI void *lcBlockAddDimAng(void *hBlock, double Xc, double Yc, double X1, double Y1, double X2, double Y2, double Xa, double Ya, double TextPos,
                             char *szText);
LCAPI void *lcBlockAddDimAng2(void *hBlock, double X1, double Y1, double X2, double Y2, double X3, double Y3, double X4, double Y4, double Xa, double Ya,
                              double TextPos, char *szText);
...
LCAPI int lcPlineGetPointOpp(void *hPline, double Dist, double *pX, double *pY, double *pAngle, double *pX2, double *pY2);
...
LCAPI int lcHatchPatLine(void *hHatch, double Angle, double x0, double y0, double dx, double dy, int nDash, double L0, double L1, double L2, double L3,
...
LCAPI int lcImageCopyQuad(void *hImage, void *hImageSrc, unsigned int W, unsigned int H, double x0, double y0, double x1, double y1, double x2, double y2,
                          double x3,
                          double y3); // undoc
...
LCAPI int lcPrintBlock(void *hBlock, double X, double Y, double W, double H, double Scal, double PapLef, double PapTop, int Options);
...
LCAPI int lcPaint_DrawImage(void *hLcWnd, void *hImage, double X, double Y, double PixelSize, int Transp, int TVal, void *hPtbuf);
LCAPI int lcPaint_DrawImage2(void *hLcWnd, void *hImage, double X, double Y, double W, double H, int Transp, int TVal, void *hPtbuf);
...
LCAPI int lcPaint_DrawArcText(void *hLcWnd, char *szText, double X, double Y, double Rad, double Ang0, int bCW, double H, double WScale, int Align);
...
LCAPI int lcPaint_PtbufAddCircle3(void *hPtbuf, double X1, double Y1, double X2, double Y2, double X3, double Y3, int bInside, int Resol);
LCAPI int lcPaint_PtbufAddArc(void *hPtbuf, double Xc, double Yc, double R, double StartAngle, double ArcAngle, int Resol);
LCAPI int lcPaint_PtbufAddArc3p(void *hPtbuf, double X1, double Y1, double X2, double Y2, double X3, double Y3, int Resol);
...
LCAPI int lcPaint_PtbufAddArcSER(void *hPtbuf, double Xs, double Ys, double Xe, double Ye, double Radius, int bClockwise, int Resol);
LCAPI int lcPaint_PtbufAddArcSEL(void *hPtbuf, double Xs, double Ys, double Xe, double Ye, double ArcLen, int bClockwise, int Resol);
...
LCAPI int lcPaint_PtbufAddArcCSE(void *hPtbuf, double Xc, double Yc, double Xs, double Ys, double Xe, double Ye, int bClockwise, int Resol);
LCAPI int lcPaint_PtbufAddArcCSA(void *hPtbuf, double Xc, double Yc, double Xs, double Ys, double AngArc, int Resol);
LCAPI int lcPaint_PtbufAddArcCSL(void *hPtbuf, double Xc, double Yc, double Xs, double Ys, double ChordLen, int bClockwise, int Resol);
LCAPI int lcPaint_PtbufAddArcCRAA(void *hPtbuf, double Xc, double Yc, double R, double AngStart, double AngEnd, int bClockwise, int Resol);
LCAPI int lcPaint_PtbufAddEllipse(void *hPtbuf, double Xc, double Yc, double Rmaj, double Rmin, double RotAng, double StartAng, double ArcAng, int Resol);
LCAPI int lcPaint_PtbufAddEllipse2(void *hPtbuf, double X1, double Y1, double X2, double Y2, int Resol);
LCAPI int lcPaint_PtbufAddRect(void *hPtbuf, double Xc, double Yc, double W, double H, double Angle, double R, int Resol);
LCAPI int lcPaint_PtbufAddRect2(void *hPtbuf, double X1, double Y1, double X2, double Y2, double R, int Resol);
LCAPI int lcPaint_PtbufAddRect3(void *hPtbuf, double X1, double Y1, double X2, double Y2, double W, int Align, double R, int Resol);
LCAPI int lcPaint_PtbufAddWline(void *hPtbuf, double X1, double Y1, double X2, double Y2, double W, int Align, int bArc, int Resol);
...
LCAPI int lcPaint_PtbufGetPoint2(void *hPtbuf, int Mode, double *pX, double *pY, double *pPrm1, double *pPrm2, int *pIntPrm);
...
LCAPI int lcPaint_MpgonAddBarcode(void *hMpgon, int BarType, double Xc, double Yc, double Width, double Height, char *szText);
