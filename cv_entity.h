...
typedef struct cv_entity_vtable {
  ...
  void (*build)(cv_entity_t *ent, cv_engine_t *engine, cv_block_ref_t *ref, double scale);
} cv_entity_vtable_t;
...
enum {
  ...
  CV_ENTITY_COLOR_BY_LAYER = 0x200,
  CV_ENTITY_COLOR_BY_BLOCK = 0x400,
  CV_ENTITY_FILLCOLOR_BY_LAYER = 0x800,
  CV_ENTITY_FILLCOLOR_BY_BLOCK = 0x1000,
...
#define CV_ENTITY_DEFINE_ATTRS()                                                                                       \
  CV_OBJECT_DEFINE_INT_RO(LC_PROP_ENT_TYPE, _cv_entity_attr_get_type),                                                 \
      CV_OBJECT_DEFINE_INT_RO(LC_PROP_ENT_ID, _cv_entity_attr_get_id),                                                 \
      CV_OBJECT_DEFINE_INT(LC_PROP_ENT_KEY, _cv_entity_attr_get_key, _cv_entity_attr_set_key),                         \
      CV_OBJECT_DEFINE_HANDLE_RO(LC_PROP_ENT_BLOCK, _cv_entity_attr_get_block),                                        \
      CV_OBJECT_DEFINE_STRING_RO(LC_PROP_ENT_BLOCK, _cv_entity_attr_get_block),                                        \
      CV_OBJECT_DEFINE_HANDLE_RO(LC_PROP_ENT_DRW, _cv_entity_attr_get_drawing),                                        \
      CV_OBJECT_DEFINE_HANDLE(LC_PROP_ENT_LAYER, _cv_entity_attr_get_layer, _cv_entity_attr_set_layer),                \
      CV_OBJECT_DEFINE_STRING(LC_PROP_ENT_LAYER, _cv_entity_attr_get_layer, _cv_entity_attr_set_layer),                \
      CV_OBJECT_DEFINE_HANDLE(LC_PROP_ENT_LINETYPE, _cv_entity_attr_get_linetype, _cv_entity_attr_set_linetype),       \
      CV_OBJECT_DEFINE_STRING(LC_PROP_ENT_LINETYPE, _cv_entity_attr_get_linetype, _cv_entity_attr_set_linetype),       \
      CV_OBJECT_DEFINE_FLOAT(LC_PROP_ENT_LTSCALE, _cv_entity_attr_get_ltscale, _cv_entity_attr_set_ltscale),           \
      CV_OBJECT_DEFINE_INT(LC_PROP_ENT_LWIDTH, _cv_entity_attr_get_lwidth, _cv_entity_attr_set_lwidth),                \
      CV_OBJECT_DEFINE_FLOAT(LC_PROP_ENT_LWIDTH, _cv_entity_attr_get_lwidth, _cv_entity_attr_set_lwidth),              \
      CV_OBJECT_DEFINE_INT(LC_PROP_ENT_PRIORITY, _cv_entity_attr_get_priority, _cv_entity_attr_set_priority),          \
      CV_OBJECT_DEFINE_BOOL_RO(LC_PROP_ENT_FROMCB, _cv_entity_attr_get_fromcb),                                        \
      CV_OBJECT_DEFINE_INT(LC_PROP_ENT_COLOR, _cv_entity_attr_get_color, _cv_entity_attr_set_color),                   \
      CV_OBJECT_DEFINE_STRING(LC_PROP_ENT_COLOR, _cv_entity_attr_get_color, _cv_entity_attr_set_color),                \
      CV_OBJECT_DEFINE_INT(LC_PROP_ENT_COLORI, _cv_entity_attr_get_colori, _cv_entity_attr_set_colori),                \
      CV_OBJECT_DEFINE_BOOL_RO(LC_PROP_ENT_COLORI, _cv_entity_attr_get_colori),                                        \
      CV_OBJECT_DEFINE_INT(LC_PROP_ENT_COLORT, _cv_entity_attr_get_colort, _cv_entity_attr_set_colort),                \
      CV_OBJECT_DEFINE_BOOL_RO(LC_PROP_ENT_COLORT, _cv_entity_attr_get_colort),                                        \
      CV_OBJECT_DEFINE_INT(LC_PROP_ENT_FCOLOR, _cv_entity_attr_get_fcolor, _cv_entity_attr_set_fcolor),                \
      CV_OBJECT_DEFINE_STRING(LC_PROP_ENT_FCOLOR, _cv_entity_attr_get_fcolor, _cv_entity_attr_set_fcolor),             \
      CV_OBJECT_DEFINE_INT(LC_PROP_ENT_FCOLORI, _cv_entity_attr_get_fcolori, _cv_entity_attr_set_fcolori),             \
      CV_OBJECT_DEFINE_BOOL_RO(LC_PROP_ENT_FCOLORI, _cv_entity_attr_get_fcolori),                                      \
      CV_OBJECT_DEFINE_INT(LC_PROP_ENT_COLORT, _cv_entity_attr_get_fcolort, _cv_entity_attr_set_fcolort),              \
      CV_OBJECT_DEFINE_BOOL_RO(LC_PROP_ENT_FCOLORT, _cv_entity_attr_get_fcolort),                                      \
      CV_OBJECT_DEFINE_BOOL(LC_PROP_ENT_COLORBYLAYER, _cv_entity_attr_get_color_by_layer,                              \
                            _cv_entity_attr_set_color_by_layer),                                                       \
      CV_OBJECT_DEFINE_BOOL(LC_PROP_ENT_COLORBYBLOCK, _cv_entity_attr_get_color_by_block,                              \
                            _cv_entity_attr_set_color_by_block),                                                       \
      CV_OBJECT_DEFINE_BOOL(LC_PROP_ENT_FCOLORBYBLOCK, _cv_entity_attr_get_fcolor_by_block,                            \
                            _cv_entity_attr_set_fcolor_by_block),                                                      \
      CV_OBJECT_DEFINE_BOOL(LC_PROP_ENT_FCOLORBYLAYER, _cv_entity_attr_get_fcolor_by_layer,                            \
                            _cv_entity_attr_set_fcolor_by_layer),                                                      \
      CV_OBJECT_DEFINE_INT(LC_PROP_ENT_FALPHA, _cv_entity_attr_get_falpha, _cv_entity_attr_set_falpha),                \
      CV_OBJECT_DEFINE_HANDLE(LC_PROP_ENT_LINFILL, _cv_entity_attr_get_linfill, _cv_entity_attr_set_linfill),          \
      CV_OBJECT_DEFINE_BOOL(LC_PROP_ENT_WIPEOUT, _cv_entity_attr_get_wipeout, _cv_entity_attr_set_wipeout),            \
      CV_OBJECT_DEFINE_BOOL_RO(LC_PROP_ENT_LOCKED, _cv_entity_attr_get_locked),                                        \
      CV_OBJECT_DEFINE_BOOL_RO(LC_PROP_ENT_VISIBLE, _cv_entity_attr_get_visible),                                      \
      CV_OBJECT_DEFINE_BOOL(LC_PROP_ENT_HIDDEN, _cv_entity_attr_get_hidden, _cv_entity_attr_set_hidden),               \
      CV_OBJECT_DEFINE_BOOL(LC_PROP_ENT_DELETED, _cv_entity_attr_get_deleted, _cv_entity_attr_set_deleted),            \
      CV_OBJECT_DEFINE_BOOL(LC_PROP_ENT_IMMORTAL, _cv_entity_attr_get_immortal, _cv_entity_attr_set_immortal),         \
      CV_OBJECT_DEFINE_BOOL(LC_PROP_ENT_SELECTED, _cv_entity_attr_get_selected, _cv_entity_attr_set_selected),         \
      CV_OBJECT_DEFINE_INT(LC_PROP_ENT_GRIPMODE, _cv_entity_attr_get_gripmode, _cv_entity_attr_set_gripmode),          \
      CV_OBJECT_DEFINE_FLOAT_RO(LC_PROP_ENT_XMIN, _cv_entity_attr_get_xmin),                                           \
      CV_OBJECT_DEFINE_FLOAT_RO(LC_PROP_ENT_YMIN, _cv_entity_attr_get_ymin),                                           \
      CV_OBJECT_DEFINE_FLOAT_RO(LC_PROP_ENT_XMIN, _cv_entity_attr_get_xmax),                                           \
      CV_OBJECT_DEFINE_FLOAT_RO(LC_PROP_ENT_YMAX, _cv_entity_attr_get_ymax),                                           \
      CV_OBJECT_DEFINE_FLOAT_RO(LC_PROP_ENT_XCEN, _cv_entity_attr_get_xcen),                                           \
      CV_OBJECT_DEFINE_FLOAT_RO(LC_PROP_ENT_YCEN, _cv_entity_attr_get_ycen),                                           \
      CV_OBJECT_DEFINE_FLOAT_RO(LC_PROP_ENT_DX, _cv_entity_attr_get_dx),                                               \
      CV_OBJECT_DEFINE_FLOAT_RO(LC_PROP_ENT_DY, _cv_entity_attr_get_dy),                                               \
      CV_OBJECT_DEFINE_FLOAT_RO(LC_PROP_ENT_LEN, _cv_entity_attr_get_len),                                             \
      CV_OBJECT_DEFINE_FLOAT(LC_PROP_ENT_Z, _cv_entity_attr_get_z, _cv_entity_attr_set_z),                             \
      CV_OBJECT_DEFINE_FLOAT(LC_PROP_ENT_THICKNESS, _cv_entity_attr_get_thickness, _cv_entity_attr_set_thickness),     \
      CV_OBJECT_DEFINE_INT_RO(LC_PROP_ENT_XDATAID, _cv_entity_attr_get_xdataid),                                       \
      CV_OBJECT_DEFINE_INT(LC_PROP_ENT_XDATAFLAGS, _cv_entity_attr_get_xdataflags, _cv_entity_attr_set_xdataflags),    \
      CV_OBJECT_DEFINE_INT_RO(LC_PROP_ENT_XDATASIZE, _cv_entity_attr_get_xdatasize),                                   \
      CV_OBJECT_DEFINE_HANDLE(LC_PROP_ENT_XDATA, _cv_entity_attr_get_xdata, _cv_entity_attr_set_xdata),                \
      CV_OBJECT_DEFINE_BOOL_RO(LC_PROP_ENT_XSTR, _cv_entity_attr_get_xstr),                                            \
      CV_OBJECT_DEFINE_STRING(LC_PROP_ENT_XSTR, _cv_entity_attr_get_xstr, _cv_entity_attr_set_xstr)
